  ...
  tagList(
    ...
    ,tags$script(
      HTML("var header = $('.navbar > .container-fluid');
                                header.append('<a href=\"https://www.yaocheng.cn\"><img src=\"www/aurora_logo_small.png\" style=\"width:158px;height:57px;float:right;padding-top:5px;\"></a>')")
    )
  )
  }
